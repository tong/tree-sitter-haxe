...
module.exports = grammar({
  ...
  rules: {
    ...
    array_access_expression: $ => prec.left(10, seq(
    ...
    map_access_expression: $ => prec.left(10, seq(
      field('map', $.expression),
      '[',
    ...
    map_literal: $ => seq(
      '[',
      seq( // Make the content mandatory
        $.key_value_pair,
    ...
    new_expression: $ => prec.right(9, seq(
      'new',
    ...
    binary_expression: $ => choice(
      prec.right(0, seq(field('left', $.expression), '=', field('right', $.expression))),
    ...
    case_statement: $ => seq(
      choice(
        seq('case', field('pattern', $.case_pattern), repeat(seq(',', field('pattern', $.case_pattern)))),
        'default'
      ),
    ...
    case_pattern: $ => choice(
      ...
      // 'null',
      '_'
    ), enum_constructor_pattern: $ => prec(1, seq(
      $.qualified_type,
      optional(field('arguments', $.pattern_argument_list))
    )),

    pattern_argument_list: $ => seq(
      '(',
      optional(seq(
        $.case_pattern,
    ...
    array_pattern: $ => prec.right(11, seq(
      '[',
      optional(seq(
        $.case_pattern,
        repeat(seq(',', $.case_pattern))
    ...
    abstract_body: $ => seq(
      '{',
      repeat($.interface_field_declaration),
      '}'
    ),
    ...
    structural_type: $ => seq(
      '{',
      repeat($.structural_field),
      '}'
    ),

    structural_field: $ => seq(
      optional('var'),
      field('name', $.identifier),
      ':',
      field('type', $.qualified_type),
    ...
    interface_field_declaration: $ => seq(
      repeat($.modifier),
      choice(
        $._variable_signature,
        $._function_signature
    ...
    enum_constructor_argument_list: $ => seq(
      '(',
      optional(seq(
